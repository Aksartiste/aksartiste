    ...
    return (
        ...
        >
            ...
            <nav
                ...
                data-oid="t2ns:.z"
            >
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12" data-oid="i-k7m:k">
                    <div
            ...
            <section
                ...
                data-oid="rri2oq_"
            >
                <div className="mb-10" data-oid="um6kuv:">
                    <h1
                ...
                <div className="prose prose-lg max-w-none" data-oid="2ynkt2s">
                    <h2 className="text-2xl sm:text-3xl font-light mb-6" data-oid="l-_8l9r">
                        Hi, I'm Akshay
                    </h2>
                    ...
                    <h2 className="text-2xl sm:text-3xl font-light mb-6 mt-10" data-oid="y2ofjxy">
                        My Work
                    </h2>
                    ...
                    <h2 className="text-2xl sm:text-3xl font-light mb-6 mt-10" data-oid=":lrzxv4">
                        Beyond Photography
                    </h2>
                    ...
                    <div className="mt-10 text-center" data-oid="p1i9qo:">
                        <Link href="/#contact" data-oid="w1dxp4h">
                            <button
            ...
            <footer
                ...
                data-oid="p64xzd6"
            >
                <div className="max-w-7xl mx-auto" data-oid="1e46jc4">
                    <div
                        className="flex flex-col md:flex-row justify-between items-center"
                        data-oid="zuy5_-s"
                    >
                        <div className="mb-6 md:mb-0" data-oid="i4a5va6">
                            <Link
                                href="/"
                        ...
                        <div className="flex space-x-8 sm:space-x-6" data-oid="85su_1a">
                            <a
                                href="#"
                                className="text-gray-500 hover:text-black transition-colors"
                                data-oid="uqzt-0i"
                            >
                                <span className="sr-only" data-oid="6z5arrd">
                                    Instagram
                                </span>
                                <svg
                            ...
                            <a
                                ...
                                data-oid="3wkulen"
                            >
                                <span className="sr-only" data-oid="qv2oa6a">
                                    Twitter
                                </span>
                                <svg
                                    className="h-6 w-6 sm:h-5 sm:w-5"
                            ...
                            <a
                                ...
                                data-oid="u5v5:kx"
                            >
                                <span className="sr-only" data-oid="cnb5x29">
                                    Pinterest
                                </span>
                                <svg
                                    className="h-6 w-6 sm:h-5 sm:w-5"

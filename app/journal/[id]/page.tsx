...
const journalEntries = [
    ...
    },
    {
      ...
      <p class="mb-6 text-base sm:text-lg text-gray-600 leading-relaxed">
        ...
        Me:- Yeah sure. (thinking since when we started using this sentence)<br>
      ...
      <p class="mb-6 text-base sm:text-lg text-gray-600 leading-relaxed">
        Days passed, we kept exploring. Something in me was dead. I wanted to walk alone now, i went out in the evening, going through market, different looking people all over the place, got myself rudraksh bracelet that i still wear. And i sat down on the ghat, experienced ganga arti & the sunset at the same time. Never in my life i had so much pain settling for good all at once. I tool no photos on that trip, 4-5 maybe. I sat alone for long, remembered my late grandfather, I could cry but it was different. Good deep breath & i was sailing through mental health.

...
export const metadata: Metadata = {
  ...
  keywords: ['photography', 'creative direction', 'portrait photography', 'fashion photography', 'fine arts'],
  authors: [{
    name: 'Akshay'
  }],
  creator: 'Akshay',
  ...
  twitter: {
    ...
    title: 'aksartiste | Photography & Creative Direction',
    description: 'A living archive of craft and emotion - Photography, Writing, Design, and Strategy',
    images: ['https://res.cloudinary.com/dexibw60d/image/upload/v1749043892/Screenshot_2025-06-04_at_7.00.25_PM_rw8lnr.png']
  },
  robots: {
    index: true,
    follow: true
...
export default function RootLayout({
  ...
  return <html lang="en" data-oid="sibtbh-">
